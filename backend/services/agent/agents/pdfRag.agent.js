...
export const pdfRag = async (state) => {
    try {
        ...
        // Supabase filter query syntax correctly applied!
        const relevantDocs = await store.similaritySearch(state.prompt, 5, { collection: collectionName });
        ...
        const messages = [
            new SystemMessage(`You are Vidyut PDF Assistant.
